...
class NetConnectionInfo(models.Model):
    ...
    dev_info = models.ForeignKey('NetWorkInfo',on_delete=models.CASCADE)
    class Meta:
...
class PhysicalServerInfo(models.Model):
    ...
    # # 物理服务器关联的机柜
    # ser_cabin = models.ForeignKey('CabinetInfo',on_delete=models.CASCADE)
    # # 用户登录系统信息
    conn_phy = models.ForeignKey('ConnectionInfo',on_delete=models.CASCADE)
...
class VirtualServerInfo(models.Model):
    ...
    # 虚拟设备关联的物理服务器
    vir_phy = models.ForeignKey('PhysicalServerInfo',on_delete=models.CASCADE)
    # 用户登录系统信息
    conn_vir = models.ForeignKey('ConnectionInfo',on_delete=models.CASCADE)
...
class NetWorkInfo(models.Model):
    ...
    # 网络设备所在的机柜
    net_cab = models.ForeignKey('CabinetInfo',on_delete=models.CASCADE)
...
class OtherMachineInfo(models.Model):
    ...
    # 关联的机柜
    oth_cab = models.ForeignKey('CabinetInfo',on_delete=models.CASCADE)
